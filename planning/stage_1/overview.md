...
This checklist turns **Stage 1: Normalize Finis Storage** from `docs/architecture/AZQ_IMPLEMENTATION_PLAN.md` into atomic, commit-sized engineering work for the current repository.
