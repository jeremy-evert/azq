...
This checklist turned **Stage 2: Implement Formam** from `docs/architecture/AZQ_IMPLEMENTATION_PLAN.md` into atomic, commit-sized engineering work for the current repository.
