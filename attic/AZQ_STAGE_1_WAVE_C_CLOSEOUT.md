...
* `docs/architecture/AZQ_BOOTSTRAP.md` and `README.md` teach the canonical file-backed goal model
...
* [ ] refactor `docs/architecture/AZQ_BOOTSTRAP.md` so bootstrap instructions no longer present `data/finis/goals.json` as the active write target
