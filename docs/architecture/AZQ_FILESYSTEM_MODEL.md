...
| `docs/architecture/` | doctrine and architecture guidance |
| `planning/` | staged build task manifests, checks, and overviews |
| `codex/` | Codex reports, support files, templates, runbooks, and tools |
| `attic/` | narrow historical notes retained for reference |
| `tests/` | unit and integration tests |
| `documents/` | supporting source documents and PDFs |
