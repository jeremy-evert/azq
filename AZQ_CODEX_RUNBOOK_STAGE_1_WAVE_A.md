...
It covers the first six tasks in `AZQ_BUILD_TASKS_STAGE_1_WAVE_A.json`:
...
* `AZQ_BUILD_TASKS_STAGE_1_WAVE_A.json`
...
Pick exactly one JSON task object from `AZQ_BUILD_TASKS_STAGE_1_WAVE_A.json`.

### Step 2: Build the prompt

Use `AZQ_CODEX_PROMPT_TEMPLATE_STAGE_1.md`.
