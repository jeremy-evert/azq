...
It covers the first nine tasks in `planning/stage_2/wave_a/tasks.json`:
...
* `planning/stage_2/wave_a/checks.json`
...
* `attic/AZQ_STAGE_1_WAVE_C_CLOSEOUT.md`
...
Pick exactly one JSON task object from `planning/stage_2/wave_a/tasks.json`.
