...
Use this template by pasting one JSON task from `planning/stage_1/wave_a/tasks.json` underneath the prompt body.
...
Copy everything below and then append one task object from `planning/stage_1/wave_a/tasks.json`.
